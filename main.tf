...
module "aks_system" {
  ...
  log_analytics_id_defender    = "/subscriptions/d3b7888f-c26e-4961-a976-ff9d5b31dfd3/resourceGroups/aks-as-a-service-lz/providers/Microsoft.OperationalInsights/workspaces/jlmyttungkvmbweb"
}
